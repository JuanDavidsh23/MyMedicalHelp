                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('Historia.destroy',$historia->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('Historia.show',$historia->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('Historia.edit',$historia->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
